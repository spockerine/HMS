		...
		return (
			<div className="fancy-button" style={buttonStyle} ref="fancyButton">
				<div className="fancy-flipper">
					...
					<div className="fancy-back" style={fancyBackStyle} onclick={this.props.click}>
						<svg height={this.props.height} width={this.props.width} viewBox={viewBox}>
...
ReactDOM.render(<FancyButton buttonText= "Consultation History"/>, document.getElementById('button1'));
ReactDOM.render(<FancyButton buttonText= "Book Appointment"/>, document.getElementById('button2'));
ReactDOM.render(<FancyButton buttonText= "Cancel Appointment"/>, document.getElementById('button3'));
ReactDOM.render(<FancyButton buttonText= "Generate Bill"/>, document.getElementById('button4'));